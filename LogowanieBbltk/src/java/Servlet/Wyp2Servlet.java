...
@WebServlet(name = "Wyp2Servlet", urlPatterns = {"/Wyp2Servlet"})
public class Wyp2Servlet extends HttpServlet {
    
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException, ClassNotFoundException, SQLException {
        response.setContentType("text/html;charset=UTF-8");
        
        String idK = request.getParameter("idK2");
        ...
        try {
            ...
            if(request.getParameter("wypozycz2")!=null) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Wyp2Servlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
